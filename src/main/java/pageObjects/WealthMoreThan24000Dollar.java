...
public class WealthMoreThan24000Dollar extends Base {
	@FindBy(id = "radio-yes")
	...
	public WealthMoreThan24000Dollar() {
	...
	public void isPageDisplayed() {
		try {
	        ...
	        if(getDriver().getTitle().startsWith("Do you have more than £24,000 in savings, investments or property?")) {
